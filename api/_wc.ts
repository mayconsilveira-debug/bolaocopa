// Lógica compartilhada da Copa (football-data.org).
// Usada pela função serverless (api/wc.ts) E pelo dev server do Vite.
// Prefixo "_" => a Vercel NÃO trata este arquivo como rota.
...
export interface OutMatch {
  ...
  round: string
  stage: string
  winner: string | null // abbr do vencedor (knockout) ou null
